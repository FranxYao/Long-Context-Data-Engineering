...
MODEL_TO_PROMPT_TEMPLATE = {
    ...
    "Yi-6B-200K":yi_base_templates,
    "Yi-6b-Chat":yi_chat_templates,
...
def process_choice(pred, options):
    a = pred.lower()[0].strip()
    if(a == "a" and options[0] not in pred): pred = pred + " " + options[0].lower()
    elif(a == "b" and options[1] not in pred): pred = pred + " " + options[1].lower()
    elif(a == "c" and options[2] not in pred): pred = pred + " " + options[2].lower()
    elif(a == "d" and options[3] not in pred): pred = pred + " " + options[3].lower()
    return pred
