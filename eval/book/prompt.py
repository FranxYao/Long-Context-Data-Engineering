...
llama_templates = {
    "longbook_qa_eng": "<|im_start|>Read the book below and answer a question.\n\n{context}\n\nQuestion: {question}\n\nAnswer:",
    "longdialogue_qa_eng": "<|im_start|>Below is a dialogue script where one random occurrence of a character name is replaced with \"$$MASK$$\", and you should try to guess who that character is.\n\n{context}\n\nThe name that has been replaced with $$MASK$$ is likely",
    "longbook_choice_eng": "<|im_start|>Read the book and answer the question.\n\n{context}\n\nQuestion: {question}\n\nOnly one of the following options is correct, tell me the answer using one single letter (A, B, C, or D).\nA. {OPTION_A}\nB. {OPTION_B}\nC. {OPTION_C}\nD. {OPTION_D}\n\nAnswer:"
}

yi_chat_templates = {
    "kv_retrieval":"<|im_start|>user\nExtract the value corresponding to the specified key in the JSON object below.\n\n{context}\n\n<|im_end|>\n<|im_start|>assistan:The value correspoding to {input} is:\n",
}
yi_base_templates = {
    "kv_retrieval":"<|im_start|>Given a json: \n\n{context}\n\n The value correspoding to {input} is:"
}
